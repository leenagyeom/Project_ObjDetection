...
# Input files
pt_file_name = "./convert/yolov5n_best.pt"
yaml_file_name = "./convert/yolov5n_best.yaml"

# Output files
cfg_file_name = "./convert/output/yolov5n.cfg"
weights_file_name = "./convert/output/yolov5n.weights"
